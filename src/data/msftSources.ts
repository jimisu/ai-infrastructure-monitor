...
export const MSFT_SOURCES: Source[] = [
  {
    id: 'msft-fy2025-q1-earnings-call', companyTicker: 'MSFT',
    name: 'Microsoft FY2025 Q1 Earnings Conference Call',
  ...
  {
    id: 'msft-fy2025-q2-earnings-call', companyTicker: 'MSFT',
    name: 'Microsoft FY2025 Q2 Earnings Conference Call',
    url: 'https://www.microsoft.com/en-us/investor/events/fy-2025/earnings-fy-2025-q2',
    tier: 'TIER_1_OFFICIAL', sourceType: 'EARNINGS_TRANSCRIPT', updateFrequency: 'quarterly',
    timezone: 'America/Los_Angeles', enabled: true,
  },
  {
    id: 'msft-fy2025-q3-earnings-call', companyTicker: 'MSFT',
    name: 'Microsoft FY2025 Q3 Earnings Conference Call',
    url: 'https://www.microsoft.com/en-us/investor/events/fy-2025/earnings-fy-2025-q3',
    tier: 'TIER_1_OFFICIAL', sourceType: 'EARNINGS_TRANSCRIPT', updateFrequency: 'quarterly',
    timezone: 'America/Los_Angeles', enabled: true,
  },
  {
    id: 'msft-fy2025-q4-earnings-call', companyTicker: 'MSFT',
    name: 'Microsoft FY2025 Q4 Earnings Conference Call',
