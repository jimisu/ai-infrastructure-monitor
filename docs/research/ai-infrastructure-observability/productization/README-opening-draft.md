# README opening — finalized productization copy

This copy is now reflected in the repository README. That documentation change does not authorize a
UI change, publication, or deployment.
...
When NVIDIA and hyperscalers report strong AI demand, this project verifies which major AI
infrastructure projects are contracted, have critical power, are under construction, or are
operating—and which face evidence-backed execution risk.

Every conclusion links to official evidence and states both:
...
Internal architecture, evidence policy, execution plans, review records, and source dossiers remain
available deeper in the repository for maintainers and reviewers; they are not the product entry
point.
